...
public final class DirectoryUserGroups {
  ...
  /**
   * Method to create the initial user groups and users in the security directory.
   */
  public static void makeUserGroups() {
    ...
    final ArrayList<DayOfWeek> monToFri =
  ...
  /**
   * Find a user within the security directory by their credentials.
   *
   * @param credential The credential of the user to find.
