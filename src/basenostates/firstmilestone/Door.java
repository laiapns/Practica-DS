...
public class Door {
   ...
   *
   * @param request The request containing the action to be processed.
   */
  ...
  /**
   * Set the next state and indicate if the door is closed.
   *
   * @param state     The next state for the door.
   * @param isClosed  Indicates if the door is closed.
   */
